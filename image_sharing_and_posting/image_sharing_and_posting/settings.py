"""
Django settings for image_sharing_and_posting project.
...
ROOT_URLCONF = 'image_sharing_and_posting.urls'
...
WSGI_APPLICATION = 'image_sharing_and_posting.wsgi.application'
