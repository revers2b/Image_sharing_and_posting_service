# Generated by Django 4.1.3 on 2022-12-11 22:18
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', models.ImageField(default='default/no_image.jpg', max_length=255, upload_to=img_share_post.models.Article.image_upload_to)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('published', models.DateTimeField(default=django.utils.timezone.now, verbose_name='Date published')),
                ('image', models.ImageField(default='default/no_image.jpg', max_length=255, upload_to=img_share_post.models.ArticleSeries.image_upload_to)),
                ('author', models.ForeignKey(default=1, on_delete=django.db.models.deletion.SET_DEFAULT, to=settings.AUTH_USER_MODEL)),
            ],
            options={
        ...
        migrations.AddField(
            model_name='article',
            name='series',
            field=models.ForeignKey(default='', on_delete=django.db.models.deletion.SET_DEFAULT, to='img_share_post.articleseries', verbose_name='Series'),
        ),
    ]
